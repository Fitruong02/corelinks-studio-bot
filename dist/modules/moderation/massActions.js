...
exports.MassModerationManager = exports.ModerationActionManager = void 0;
...
class MassModerationManager extends ModerationActionManager {
    async massKickByRole(roleId, moderator, reason) {
        return false;
    }
    async massTimeoutNewMembers(hours, moderator, reason, duration) {
        return false;
    }
}
exports.MassModerationManager = MassModerationManager;
//# sourceMappingURL=massActions.js.map
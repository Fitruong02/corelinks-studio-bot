...
export declare class MassModerationManager extends ModerationActionManager {
    massKickByRole(roleId: string, moderator: any, reason: string): Promise<boolean>;
    massTimeoutNewMembers(hours: number, moderator: any, reason: string, duration: number): Promise<boolean>;
}
export {};
//# sourceMappingURL=massActions.d.ts.map